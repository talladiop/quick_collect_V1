...
<ul>
    <?php
        ...
        while($rowrep=mysql_fetch_row($resrep)){
            ...
            <li>
                <input type="checkbox"/>
                <input type="text" id="<?php echo 'rep'.$cpt_ques.'_'.$cpt_case; ?>" name="<?php echo 'rep'.$cpt_ques.'_'.$cpt_case; ?>" placeholder="<?php echo "Option ".$cpt_case; ?>" value="<?php echo $rowrep[2];?>"/>
